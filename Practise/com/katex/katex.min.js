(function(e) {
    ...
    return function l(e, t, i) {
        ...
        for (var s = 0; s < i.length; s++) h(i[s]);
        return h
    }({
        1: [function(e, t, i) {
            ...
            var p = function(e, t) {
				...
				var _innerHtml = h.innerHTML;
				_innerHtml = _innerHtml.replace(/\>-</g, ">&ndash;<");
				$(t).append('<span class="katex">'+_innerHtml+'</span>');
            };
            var r = function(e) {
                var t = l(e);
                return a(t).toMarkup()
        ...
        2: [function(e, t, i) {
            ...
            a.prototype._innerLex = function(e, t, i) {
                ...
                var p;
                if (p = a.match(g)) {
                    return new l(p[0], p[0], e + p[0].length)
                } else {
                    for (var d = 0; d < t.length; d++) {
                        var n = t[d];
                        if (p = a.match(n[0])) {
                            return new l(n[1], p[0], e + p[0].length)
                        }
                    }
                }
            ...
            a.prototype._innerLexColor = function(e) {
                ...
                var a;
                if (a = t.match(d)) {
                    return new l("color", a[0], e + a[0].length)
                } else {
        ...
        5: [function(e, t, i) {
            ...
            r.prototype.expect = function(e, t) {
                if (e.type !== t) {
                    throw new p("Expected '" + t + "', got '" + e.type + "'", this.lexer, e.position)
                }
            };
            ...
            r.prototype.parseInput = function(e, t) {
                var i = this.parseExpression(e, t);
                var h = this.lexer.lex(i.position, t);
                this.expect(h, "EOF");
                return i
            };
            r.prototype.handleExpressionBody = function(e, t) {
                var i = [];
                var h;
                while (h = this.parseAtom(e, t)) {
                    i.push(h.result);
                    e = h.position
                }
                return {
            ...
            r.prototype.parseExpression = function(e, t) {
                var i = this.handleExpressionBody(e, t);
                return new g(i.body, i.position)
            };
            var n = 1;
            r.prototype.handleSupSubscript = function(e, t, i, a) {
                var l = this.parseGroup(e, t);
                if (!l) {
                    throw new p("Expected group after '" + i + "'", this.lexer, e)
                } else if (l.numArgs > 0) {
                    var s = h.getGreediness(l.result.result);
                    if (s > n) {
                        return this.parseFunction(e, t)
                    } else {
                        throw new p("Got function '" + l.result.result + "' with no arguments " + "as " + a, this.lexer, e)
                    }
                } else {
                    return l.result
                }
            };
            r.prototype.parseAtom = function(e, t) {
                ...
                while (true) {
                    ...
                    if (s.type === "^") {
                        if (a) {
                            throw new p("Double superscript", this.lexer, h)
                        }
                        var d = this.handleSupSubscript(s.position, t, s.type, "superscript");
                        h = d.position;
                        a = d.result
                    } else if (s.type === "_") {
                        if (l) {
                            throw new p("Double subscript", this.lexer, h)
                        }
                        var d = this.handleSupSubscript(s.position, t, s.type, "subscript");
                        h = d.position;
                        l = d.result
                    } else if (s.type === "'") {
                        var n = new c("textord", "\\prime", t);
                        var o = [n];
                        h = s.position;
                        while ((s = this.lexer.lex(h, t)).type === "'") {
                            o.push(n);
                            h = s.position
                        }
            ...
            r.prototype.parseImplicitGroup = function(e, t) {
                ...
                if (h === "\\left") {
                    ...
                    var l = this.handleExpressionBody(a.position, t);
                    var r = this.parseSymbol(l.position, t);
                    if (r && r.result.result === "\\right") {
                        var d = this.parseFunction(l.position, t);
                        return new g(new c("leftright", {
                            body: l.body,
                            left: a.result.value.value,
                            right: d.result.value.value
                        }, t), d.position)
                    } else {
                        throw new p("Missing \\right", this.lexer, l.position)
                    }
                } else if (h === "\\right") {
                    return null
                } else if (s.contains(o, h)) {
                    var l = this.handleExpressionBody(i.result.position, t);
                    return new g(new c("sizing", {
                        size: "size" + (s.indexOf(o, h) + 1),
                        value: l.body
                    }, t), l.position)
            ...
            r.prototype.parseFunction = function(e, t) {
                var i = this.parseGroup(e, t);
                if (i) {
                    if (i.isFunction) {
                        var a = i.result.result;
                        if (t === "text" && !i.allowedInText) {
                            throw new p("Can't use function '" + a + "' in text mode", this.lexer, i.position)
                        }
                        var l = i.result.position;
                        var s;
                        if (i.numArgs > 0) {
                            var r = h.getGreediness(a);
                            var d = [a];
                            var n = [l];
                            for (var o = 0; o < i.numArgs; o++) {
                                var w = i.argTypes && i.argTypes[o];
                                if (w) {
                                    var k = this.parseSpecialGroup(l, w, t)
                                } else {
                                    var k = this.parseGroup(l, t)
                                }
                                if (!k) {
                                    throw new p("Expected group after '" + i.result.result + "'", this.lexer, l)
                                }
                                var u;
                                if (k.numArgs > 0) {
                                    var m = h.getGreediness(k.result.result);
                                    if (m > r) {
                                        u = this.parseFunction(l, t)
                                    } else {
                                        throw new p("Got function '" + k.result.result + "' as " + "argument to function '" + i.result.result + "'", this.lexer, k.result.position - 1)
                                    }
                                } else {
                                    u = k.result
                                }
                            ...
                            d.push(n);
                            s = h.funcs[a].handler.apply(this, d)
                        } else {
            ...
            r.prototype.parseSpecialGroup = function(e, t, i) {
                if (t === "color" || t === "size") {
                    var h = this.lexer.lex(e, i);
                    this.expect(h, "{");
                    var a = this.lexer.lex(h.position, t);
                    var l = this.lexer.lex(a.position, i);
                    this.expect(l, "}");
                    return new d(new g(new c("color", a.text, i), l.position), false)
                } else if (t === "text") {
                    var s = this.lexer.lex(e, "whitespace");
                    return this.parseGroup(s.position, t)
                } else {
                    return this.parseGroup(e, t)
                }
            };
            r.prototype.parseGroup = function(e, t) {
                var i = this.lexer.lex(e, t);
                if (i.type === "{") {
                    var h = this.parseExpression(i.position, t);
                    var a = this.lexer.lex(h.position, t);
                    this.expect(a, "}");
            ...
            r.prototype.parseSymbol = function(e, t) {
                var i = this.lexer.lex(e, t);
                if (h.funcs[i.type]) {
                    var a = h.funcs[i.type];
                    var s = a.argTypes;
                    if (s) {
                        s = s.slice();
                    ...
                    return new d(new g(i.type, i.position), true, a.allowedInText, a.numArgs, s)
                } else if (l[t][i.text]) {
        ...
        6: [function(e, t, i) {
            ...
            var w = [new h(a, 0, 1, false), new h(l, 0, 1, true), new h(s, 1, 1, false), new h(p, 1, 1, true), new h(r, 2, .7, false), new h(c, 2, .7, true), new h(g, 3, .5, false), new h(d, 3, .5, true)];
            var k = [r, c, r, c, g, d, g, d];
            var u = [c, c, c, c, d, d, d, d];
            var m = [s, p, r, c, g, d, g, d];
            var f = [p, p, c, c, d, d, d, d];
            var v = [l, l, p, p, c, c, d, d];
            t.exports = {
                DISPLAY: w[a],
                TEXT: w[s],
                SCRIPT: w[r],
        ...
        7: [function(e, t, i) {
            ...
            var a = e("./fontMetrics");
            var l = e("./symbols");
            var s = function(e, t, i, s, p) {
                if (l[i][e] && l[i][e].replace) {
                    e = l[i][e].replace
                }
                var r = a.getCharacterMetrics(e, t);
                var c;
                if (r) {
                    c = new h.symbolNode(e, r.height, r.depth, r.italic, r.skew, p)
                } else {
                    typeof console !== "undefined" && console.warn("No character metrics for '" + e + "' in style '" + t + "'");
                    c = new h.symbolNode(e, 0, 0, 0, 0, p)
                }
                if (s) {
                    c.style.color = s
                }
            ...
            var o = function(e, t, i, a) {
                ...
                if (t === "individualShift") {
                    var s = e;
                    e = [s[0]];
                    l = -s[0].shift - s[0].elem.depth;
                    var p = l;
                    for (var r = 1; r < s.length; r++) {
                        var c = -s[r].shift - p - s[r].elem.depth;
                        var d = c - (s[r - 1].elem.height + s[r - 1].elem.depth);
                        p = p + c;
                        e.push({
                            type: "kern",
                            size: d
        ...
        8: [function(e, t, i) {
            ...
            var y = {
                ...
                ordgroup: function(e, t, i) {
                    return o(["mord", t.style.cls()], w(e.value, t.reset()))
                },
                text: function(e, t, i) {
                    return o(["text", "mord", t.style.cls()], w(e.value.body, t.reset()))
                },
                color: function(e, t, i) {
                    var h = w(e.value.value, t.withColor(e.value.color), i);
                    return new s.makeFragment(h)
                },
                supsub: function(e, t, i) {
                    var h = e.value.base;
                    if (m(e.value.base, t)) {
                        return y[e.value.base.type](e, t, i)
                    }
                    var a = b(e.value.base, t.reset());
                    if (e.value.sup) {
                        var p = b(e.value.sup, t.withStyle(t.style.sup()));
                        var g = o([t.style.reset(), t.style.sup().cls()], [p])
                    }
                    if (e.value.sub) {
                        var d = b(e.value.sub, t.withStyle(t.style.sub()));
                        var n = o([t.style.reset(), t.style.sub().cls()], [d])
                    }
                    var w, k;
                    if (v(e.value.base)) {
                        w = 0;
                        ...
                        w = a.height - c.metrics.supDrop;
                        k = a.depth + c.metrics.subDrop
                    }
                    var f;
                    ...
                    var z = .5 / c.metrics.ptPerEm / x + "em";
                    var S;
                    if (!e.value.sup) {
                        k = Math.max(k, c.metrics.sub1, d.height - .8 * c.metrics.xHeight);
                        S = s.makeVList([{
                            type: "elem",
                            elem: n
                        }], "shift", k, t);
                        S.children[0].style.marginRight = z;
                        if (a instanceof r.symbolNode) {
                            S.children[0].style.marginLeft = -a.italic + "em"
                        }
                    } else if (!e.value.sub) {
                        w = Math.max(w, f, p.depth + .25 * c.metrics.xHeight);
                        S = s.makeVList([{
                            type: "elem",
                            elem: g
                        }], "shift", -w, t);
                        ...
                        var T = c.metrics.defaultRuleThickness;
                        if (w - p.depth - (d.height - k) < 4 * T) {
                            k = 4 * T - (w - p.depth) + d.height;
                            var M = .8 * c.metrics.xHeight - (w - p.depth);
                            if (M > 0) {
                                w += M;
                                k -= M
                            }
                        ...
                        S.children[0].style.marginRight = z;
                        S.children[1].style.marginRight = z
                    }
                    return o([u(e.value.base)], [a, S])
                },
                frac: function(e, t, i) {
                    var h = t.style;
                    if (e.value.size === "dfrac") {
                        h = l.DISPLAY
                    } else if (e.value.size === "tfrac") {
                        h = l.TEXT
                    }
                    var a = h.fracNum();
                    var p = h.fracDen();
                    var r = b(e.value.numer, t.withStyle(a));
                    var g = o([h.reset(), a.cls()], [r]);
                    var d = b(e.value.denom, t.withStyle(p));
                    var n = o([h.reset(), p.cls()], [d]);
                    var w = c.metrics.defaultRuleThickness / t.style.sizeMultiplier;
                    var k = o([t.style.reset(), l.TEXT.cls(), "frac-line"]);
                    k.height = w;
                    var u, m, f;
                    ...
                    var v = c.metrics.axisHeight;
                    if (u - r.depth - (v + .5 * w) < f) {
                        u += f - (u - r.depth - (v + .5 * w))
                    }
                    if (v - .5 * w - (d.height - m) < f) {
                        m += f - (v - .5 * w - (d.height - m))
                    }
                    var y = -(v - .5 * w);
                    var x = s.makeVList([{
                        type: "elem",
                    ...
                    return o(["minner", "mfrac", t.style.reset(), h.cls()], [x], t.getColor())
                },
                spacing: function(e, t, i) {
                    if (e.value === "\\ " || e.value === "\\space" || e.value === " " || e.value === "~") {
                        return o(["mord", "mspace"], [s.mathrm(e.value, e.mode)])
                    } else {
                        var h = {
                            "\\qquad": "qquad",
                            "\\quad": "quad",
                ...
                llap: function(e, t, i) {
                    var h = o(["inner"], [b(e.value.body, t.reset())]);
                    var a = o(["fix"], []);
                ...
                op: function(e, t, i) {
                    ...
                    var r = ["\\smallint"];
                    var g = false;
                    if (t.style.size === l.DISPLAY.size && e.value.symbol && !n.contains(r, e.value.body)) {
                        g = true
                    }
                    var d;
                    var w = 0;
                    var k = 0;
                    if (e.value.symbol) {
                        var u = g ? "Size2-Regular" : "Size1-Regular";
                        d = s.makeSymbol(e.value.body, u, "math", t.getColor(), ["op-symbol", g ? "large-op" : "small-op", "mop"]);
                        w = (d.height - d.depth) / 2 - c.metrics.axisHeight * t.style.sizeMultiplier;
                        k = d.italic
                    } else {
                        var m = [];
                    ...
                    if (p) {
                        ...
                        var v, y, x, z;
                        if (h) {
                            var S = b(h, t.withStyle(t.style.sup()));
                            v = o([t.style.reset(), t.style.sup().cls()], [S]);
                            y = Math.max(c.metrics.bigOpSpacing1, c.metrics.bigOpSpacing3 - S.depth)
                        }
                        if (a) {
                            var T = b(a, t.withStyle(t.style.sub()));
                            x = o([t.style.reset(), t.style.sub().cls()], [T]);
                        ...
                        if (!h) {
                            ...
                            var C = c.metrics.bigOpSpacing5 + x.height + x.depth + z + d.depth + w;
                            M = s.makeVList([{
                                type: "kern",
                                size: c.metrics.bigOpSpacing5
                            }, {
                ...
                katex: function(e, t, i) {
                    var h = o(["k"], [s.mathrm("K", e.mode)]);
                    var a = o(["a"], [s.mathrm("A", e.mode)]);
                    a.height = (a.height + .2) * .75;
                    a.depth = (a.height - .2) * .75;
                    var l = o(["t"], [s.mathrm("T", e.mode)]);
                    var p = o(["e"], [s.mathrm("E", e.mode)]);
                    p.height = p.height - .2155;
                    p.depth = p.depth + .2155;
                    var r = o(["x"], [s.mathrm("X", e.mode)]);
                    return o(["katex-logo"], [h, a, l, p, r], t.getColor())
                },
                overline: function(e, t, i) {
                    var h = b(e.value.body, t.withStyle(t.style.cramp()));
                    var a = c.metrics.defaultRuleThickness / t.style.sizeMultiplier;
                    var p = o([t.style.reset(), l.TEXT.cls(), "overline-line"]);
                    p.height = a;
                    p.maxFontSize = 1;
                    var r = s.makeVList([{
                        type: "elem",
                    ...
                    return o(["overline", "mord"], [r], t.getColor())
                },
                sqrt: function(e, t, i) {
                    var h = b(e.value.body, t.withStyle(t.style.cramp()));
                    var a = c.metrics.defaultRuleThickness / t.style.sizeMultiplier;
                    var r = o([t.style.reset(), l.TEXT.cls(), "sqrt-line"], [], t.getColor());
                    r.height = a;
                    r.maxFontSize = 1;
                    var g = a;
                    ...
                    var d = a + g / 4;
                    var n = (h.height + h.depth) * t.style.sizeMultiplier;
                    var w = n + d + a;
                    var k = o(["sqrt-sign"], [p.customSizedDelim("\\surd", w, false, t, e.mode)], t.getColor());
                    var u = k.height + k.depth - a;
                    if (u > h.height + h.depth + d) {
                        d = (d + u - h.height - h.depth) / 2
                    }
                    delimShift = -(h.height + d + a) + k.height;
                    k.style.top = delimShift + "em";
                    k.height -= delimShift;
                    k.depth += delimShift;
                    var m;
                    ...
                    return o(["sqrt", "mord"], [k, m])
                },
                sizing: function(e, t, i) {
                    var h = w(e.value.value, t.withSize(e.value.size), i);
                    var a = o(["mord"], [o(["sizing", "reset-" + t.size, e.value.size, t.style.cls()], h)]);
                    var l = x[e.value.size];
                ...
                styling: function(e, t, i) {
                    ...
                    var s = w(e.value.value, t.withStyle(a), i);
                    return o([t.style.reset(), a.cls()], s)
                },
                delimsizing: function(e, t, i) {
                    var h = e.value.value;
                    if (h === ".") {
                        return o([k[e.value.delimType]])
                    }
                    return o([k[e.value.delimType]], [p.sizedDelim(h, e.value.size, t, e.mode)])
                },
                leftright: function(e, t, i) {
                    var h = w(e.value.body, t.reset());
                    var a = 0;
                    var l = 0;
                    ...
                    if (e.value.left === ".") {
                        ...
                        r = p.leftRightDelim(e.value.left, a, l, t, e.mode)
                    }
                    h.unshift(r);
                    var c;
                    if (e.value.right === ".") {
                        ...
                        c = p.leftRightDelim(e.value.right, a, l, t, e.mode)
                    }
                    h.push(c);
                ...
                accent: function(e, t, i) {
                    ...
                    var p = b(h, t.withStyle(t.style.cramp()));
                    var r;
                    if (v(h)) {
                        var g = f(h);
                        var d = b(g, t.withStyle(t.style.cramp()));
                        r = d.skew
                    } else {
                        r = 0
                    }
                    var n = Math.min(p.height, c.metrics.xHeight);
                    var w = s.makeSymbol(e.value.accent, "Main-Regular", "math", t.getColor());
                    w.italic = 0;
                    var k = e.value.accent === "\\vec" ? "accent-vec" : null;
                    var u = o(["accent-body", k], [o([], [w])]);
                    var u = s.makeVList([{
                        type: "elem",
                        elem: p
                    }, {
                    ...
                    u.children[1].style.marginLeft = 2 * r + "em";
                    var m = o(["mord", "accent"], [u]);
                    if (a) {
                        a.children[0] = m;
            ...
            var b = function(e, t, i) {
                ...
                if (y[e.type]) {
                    var h = y[e.type](e, t, i);
                    if (t.style !== t.parentStyle) {
                        var l = t.style.sizeMultiplier / t.parentStyle.sizeMultiplier;
                        h.height *= l;
                        h.depth *= l
                    }
                    if (t.size !== t.parentSize) {
                        var l = x[t.size] / x[t.parentSize];
                        h.height *= l;
                        h.depth *= l
                    }
                    return h
            ...
            var z = function(e) {
                ...
                var s = o(["strut"]);
                var p = o(["strut", "bottom"]);
                s.style.height = a.height + "em";
                p.style.height = a.height + a.depth + "em";
                p.style.verticalAlign = -a.depth + "em";
                var r = o(["katex"], [o(["katex-inner"], [s, p, a])]);
                return r
            };
            t.exports = z
        }, {
        ...
        9: [function(e, t, i) {
            ...
            var n = s.makeSpan;
            var o = function(e, t) {
                if (g["math"][e] && g["math"][e].replace) {
                    return r.getCharacterMetrics(g["math"][e].replace, t)
                } else {
            ...
            var u = function(e, t, i, h, a) {
                var l = s.makeSymbol(e, "Main-Regular", a);
                var p = k(l, t, h);
                if (i) {
                    var c = (1 - h.style.sizeMultiplier / t.sizeMultiplier) * r.metrics.axisHeight;
                    p.style.top = c + "em";
                    p.height -= c;
                    p.depth += c
                }
            ...
            var m = function(e, t, i, h, a) {
                var s = w(e, t, a);
                var p = k(n(["delimsizing", "size" + t], [s], h.getColor()), l.TEXT, h);
                if (i) {
            ...
            var v = function(e, t, i, h, a) {
                ...
                if (e === "\\uparrow") {
                    ...
                    g = "‖";
                    d = "\\Downarrow"
                } else if (e === "|" || e === "\\vert") {} else if (e === "\\|" || e === "\\Vert") {} else if (e === "[" || e === "\\lbrack") {
                    p = "⎡";
                    g = "⎢";
                    d = "⎣";
                    w = "Size4-Regular"
                ...
                E.push(f(p, w, a));
                var B = s.makeVList(E, "bottom", C, h);
                return k(n(["delimsizing", "mult"], [B], h.getColor()), l.TEXT, h)
            };
            var y = ["(", ")", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\\lceil", "\\rceil", "\\surd"];
            var x = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert"];
            var b = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash"];
            ...
            var S = function(e, t, i, h) {
                ...
                var l;
                if (d.contains(y, e) || d.contains(b, e)) {
                    return m(e, t, false, i, h)
                } else if (d.contains(x, e)) {
                    return v(e, z[t], false, i, h)
                } else {
            ...
            var E = function(e, t, i, h) {
                ...
                for (var l = a; l < i.length; l++) {
                    ...
                    var s = o(e, C(i[l]));
                    var p = s.height + s.depth;
                    if (i[l].type === "small") {
                        p *= i[l].style.sizeMultiplier
                    }
                    if (p > t) {
                        return i[l]
                    }
            ...
            var P = function(e, t, i, h, a) {
                ...
                var s = E(e, t, l, h);
                if (s.type === "small") {
                    return u(e, s.style, i, h, a)
                } else if (s.type === "large") {
                    return m(e, s.size, i, h, a)
                } else if (s.type === "stack") {
                    return v(e, t, i, h, a)
                }
            };
            var A = function(e, t, i, h, a) {
                var l = r.metrics.axisHeight * h.style.sizeMultiplier;
                var s = 901;
                var p = 5 / r.metrics.ptPerEm;
                var c = Math.max(t - l, i + l);
                var g = Math.max(c / 500 * s, 2 * c - p);
                return P(e, g, true, h, a)
            };
            t.exports = {
                sizedDelim: S,
                customSizedDelim: P,
        ...
        11: [function(e, t, i) {
            ...
            var G = function(e, t) {
                return N[t][e.charCodeAt(0)]
            };
            t.exports = {
                metrics: _,
                getCharacterMetrics: G
            }
        }, {}],
        12: [function(e, t, i) {
            var h = e("./utils");
            ...
            var p = ["(", ")", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\\lceil", "\\rceil", "<", ">", "\\langle", "\\rangle", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
            var r = [{
